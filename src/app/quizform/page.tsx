    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-black via-purple-600 to-black text-white flex flex-col items-center justify-center p-4">
        ...
        {form && showLeaderboard && (
          <div className="flex flex-col md:flex-row gap-8 md:gap-20 w-full max-w-4xl">
            {/* Quiz Form */}
            <div className="flex-1">
              <form onSubmit={handleSubmit} className="flex text-black flex-col gap-4 p-8 rounded-lg bg-black/50 backdrop-blur-md shadow-lg w-full">
                ...
                <button type="submit" disabled={loading} className="mt-4 px-4 py-2 bg-purple-700 rounded-lg shadow hover:bg-purple-800 transition disabled:bg-gray-500">{loading ? 'Getting Questions' : 'Bring it on'}</button>
            ...
            {/* Leaderboard Section */}
            <div className="flex-1">
              <div className="flex flex-col gap-4 p-8 rounded-lg bg-black/50 backdrop-blur-md shadow-lg w-full">
        ...
        {quizStarted && questions.length > 0 && (
          <div className="mt-8 p-4 border rounded-lg bg-black/50 backdrop-blur-md shadow-lg text-white max-w-2xl mx-auto w-full">
            {mode && (
              <div className="mb-4 text-red-400 font-bold text-xl text-center">
        ...
        {/* Results Section */}
        {evaluated && result && (
          <div className="mt-8 p-6 border rounded-lg bg-black/50 backdrop-blur-md shadow-lg text-white max-w-2xl mx-auto w-full">
        ...
        {timeUpModal && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4">
            <div className="bg-gray-800 p-8 rounded-lg text-center text-white">
              ...
              <p className="mb-6">You have run out of time to complete the quiz.</p>
              <button
                onClick={handleTimeUp}
                className="px-6 py-2 bg-red-600 rounded-lg shadow hover:bg-red-700 transition"
              >
                See Results
              </button>
            </div>
