...
const About: React.FC = () => {
 return (
  <div>
   ...
   <a  href="https://www.instagram.com/amiteshtutorials/"><Image src="/instagramm.png" alt="insta logo" width={70} height={70} /></a>
   </header>
   ...
   <main>
     ...
     <h2 className="font-bold font-serif text-3xl lg:text-5xl underline underline-offset-4 text-black text-center p-3 bg-yellow-400">Meet The Founder</h2>
     <div className="flex flex-col lg:flex-row text-black bg-yellow-400 p-3">
       <img src="/founder.jpg" alt="founders image" className=" lg:w-1/3 h-auto mb-4"/>
       <div className="flex flex-col justify-center items-center lg:w-2/3 ">
        ...
        <p className="font-semibold italic font-serif text-xl text-center">“As you embark on this educational journey, remember that every   challenge is an opportunity for growth. Keep pushing forward!” <span className="whitespace-nowrap">-Amitesh  Tripathi</span></p>
      </div>
     </div>   
 
     <div className="bg-blue-600 mt-5 mb-5 p-4">
      <h2 className="text-4xl font-serif underline underline-offset-4 text-white font-bold text-start p-3 mb-3">Our Philosophy</h2>
     ...
     <div className="bg-blue-600 text-white text-center text-xl font-serif lg:text-2xl p-5 mb-5">
